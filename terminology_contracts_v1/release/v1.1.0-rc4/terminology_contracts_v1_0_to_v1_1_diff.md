...
- Certificate application fields are exact bundle projections: positive
  support refs, frozen variants/blacklist/scope, C/E features, calibration
  operating-point ID, and decision completion ordering.
