...
| Contract | Schema ID | Active | Legacy | Boundary owner |
|---|---|---:|---:|---|
...
| Global input | `GlobalValidatorInputV1` | 1.1.0 | 1.0.0 | Global Validator |
| Hard gates | `GateResultSetV1` | 1.1.0 | 1.0.0 | Gate engine |
| Gate policy | `GatePolicyArtifactV1` | 1.1.0 | None | Contract Steward |
| Calibration | `CalibrationArtifactV1` | 1.1.0 | 1.0.0 | Calibration engine |
| Decision | `GlobalDecisionPackageV1` | 1.1.0 | 1.0.0 | Global Validator |
