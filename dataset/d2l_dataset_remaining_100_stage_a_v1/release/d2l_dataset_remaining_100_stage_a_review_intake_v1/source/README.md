...
After the two independent reviews validate, the review-intake artifact keeps
four routes separate: Reviewer 3 adjudication for mandatory R4 and disputed R3
cases, R3 dual agreement, R0 blind-audit candidates, and R0 dataset repair.
Neither intake nor adjudication may emit Stage B gold or a final glossary
decision.
