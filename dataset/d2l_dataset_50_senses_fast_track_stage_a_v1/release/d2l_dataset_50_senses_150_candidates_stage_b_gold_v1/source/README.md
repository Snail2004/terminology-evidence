...
Once Reviewer 3 completes every disagreement, `build_stage_b_gold_release.py`
freezes all 150 candidate-level Stage B labels in a companion artifact. This
completes the evaluation gold layer but deliberately leaves C/E evaluation and
Global Validator glossary decisions unrun.
