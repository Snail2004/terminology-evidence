...
def _event_schema() -> dict[str, Any]:
    ...
    payloads = [
        ...
        payload(["candidate_id", "sense_id", "semantic_role", "semantic_call_id", "provider_request_id", "retry_index", "provider_id", "model_id", "route", "prompt_sha256", "request_sha256", "response_sha256", "raw_response_locator", "generation_config", "provider_role_plan_sha256"], {"candidate_id": STRING, "sense_id": STRING, "semantic_role": STRING, "semantic_call_id": STRING, "provider_request_id": STRING, "retry_index": NONNEGATIVE, "provider_id": STRING, "model_id": STRING, "route": STRING, "prompt_sha256": SHA256, "request_sha256": SHA256, "response_sha256": SHA256, "raw_response_locator": STRING, "generation_config": {"type": "object", "additionalProperties": False, "required": ["temperature", "reasoning"], "properties": {"temperature": {"type": "number", "minimum": 0, "maximum": 2}, "reasoning": STRING}}, "provider_role_plan_sha256": SHA256}),
